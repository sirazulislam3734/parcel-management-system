...
const AppStatistics = () => {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:4000/deliveredCount")
  ...
  return (
    <div className="p-4 lg:px-20 bg-base-200 md:px-10 md:py-5">
      ...
      <p className="text-sm md:text-lg text-center font-normal lg:mb-3 mb-1 lg:w-3/5 mx-auto">
        Our Statistics In this section you will see all the booked parcels and
        along with that you will see the number of parcels delivered by the
        delivery man and those who are running our app.
      </p>
